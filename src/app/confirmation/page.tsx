...
function ConfirmationContent() {
  ...
  return (
    <div className="min-h-screen">
      <nav className="flex items-center justify-center px-6 py-4 max-w-3xl md:max-w-6xl mx-auto">
        <span className="text-2xl font-bold tracking-tight" style={{ color: '#0066FF' }}>
          Memora
        </span>
      </nav>

      <div className="px-6 pb-12 max-w-xl md:max-w-3xl mx-auto text-center">
